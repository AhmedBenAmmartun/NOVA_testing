...
| Microsoft WebView2 | Native webview runtime for the packaged NOVA Desktop widget | Yes for desktop widget | WebView2 runtime is installed on this machine; distribution should follow Microsoft WebView2 guidance. |
| Tauri | Native frameless Windows widget wrapper and bundler for the Dashboard shell | Yes for desktop widget | Rust/Tauri terms and bundled dependency licenses apply. |
| NSIS | Windows installer generated by Tauri | Yes for installer output | Tauri downloads verified NSIS tooling during bundle build. |
...
Dashboard/frontend dependencies from `Dashboard/package.json`:
...
- [ ] Verify Tauri/Rust crate licenses before distributing the installer.
